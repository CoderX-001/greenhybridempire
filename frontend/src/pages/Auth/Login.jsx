      ...
      >
        <div className="relative">
          ...
          <div className="relative mt-16">
            ...
            <ButtonWithIcon
              buttonStyle={
                `flex-row-reverse w-fit mx-auto mb-4 py-2 px-2 rounded-md ${isDark ? "text-primary-gray": "text-black"}
                shadow-md border-[1px] ${isDark ? "border-primary-gray" : "border-secondary-gray"}`
              }
            ...
            <div className="w-3/4 mx-auto relative mb-12">
              ...
              <p className={`relative w-fit px-1 rounded-full mx-auto z-[2] text-center ${isDark ? "bg-[#121212] text-primary-gray" : "bg-white text-secondary-gray"}`}>
                or
              </p>
            </div>
