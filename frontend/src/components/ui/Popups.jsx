...
export const SearchPopup = () => {
  ...
  return (
    <div
      className={`blur-bg w-full fixed z-[9999] top-0 left-0 ${
        searchActive ? "overflow-auto" : "overflow-hidden"
      }`}
      style={{
    ...
    >
      <div className="blur-bg-content absolute top-0 left-0 px-4 py-6">
        ...
        <div className="mt-6 relative">
          {searchText !== "" ? (
            <p className="text-2xl text-center text-white drop-shadow-lg shadow-black">
